  ...
  return (
    <div className="admin-dashboard">
      <div className="dashboard-header">
        <div>
          <h1 className="dashboard-title">Supplier Submissions</h1>
          <p className="dashboard-subtitle">Review and manage supplier compliance submissions</p>
        </div>
        <div className="dashboard-actions">
          <button className="btn btn-outline btn-sm" onClick={() => handleExport('csv')} disabled={exporting}>
            {exporting ? <span className="spinner" style={{border:'2px solid #ccc', borderTopColor:'#333'}} /> : (
          ...
          <button className="btn btn-black btn-sm" onClick={() => handleExport('xlsx')} disabled={exporting}>
